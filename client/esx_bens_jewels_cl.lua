...
RegisterNetEvent('esx_bens_jewels:currentlyrobbing')
AddEventHandler('esx_bens_jewels:currentlyrobbing', function(robb)
	holdingup = true
	store = robb
end)

RegisterNetEvent('esx_bens_jewels:killblip')
AddEventHandler('esx_bens_jewels:killblip', function()
    RemoveBlip(blipRobbery)
end)

RegisterNetEvent('esx_bens_jewels:setblip')
AddEventHandler('esx_bens_jewels:setblip', function(position)
...
RegisterNetEvent('esx_bens_jewels:toofarlocal')
AddEventHandler('esx_bens_jewels:toofarlocal', function(robb)
	holdingup = false
...
RegisterNetEvent('esx_bens_jewels:robberycomplete')
AddEventHandler('esx_bens_jewels:robberycomplete', function(robb)
	holdingup = false
	...
	while true do
				...
				if not holdingup then
					...
					if(Vdist(pos.x, pos.y, pos.z, pos2.x, pos2.y, pos2.z) < 1.0)then
						...
						if IsPedShooting(GetPlayerPed(-1)) then
							...
							TriggerServerEvent('esx_bens_jewels:rob', k)
                        end
		...
		if holdingup then
							...
							if IsControlJustReleased(1, 51) then
								...
								TriggerServerEvent('esx_bens_jewels:gioielli1')
                            ...
                            hasrobbed19 = false
                            hasrobbed20 = false
							TriggerServerEvent('esx_bens_jewels:endrob', store)
			...
			if (GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), -622.566, -230.183, 38.057, true) > 11.5 ) then
				TriggerServerEvent('esx_bens_jewels:toofar', store)
				holdingup = false
				RemoveBlip(gioielli1)
				RemoveBlip(gioielli2)
				RemoveBlip(gioielli3)
...
RegisterNetEvent('esx_bens_jewels:togliblip')
AddEventHandler('esx_bens_jewels:togliblip', function(robb)
	RemoveBlip(gioielli1)
	RemoveBlip(gioielli2)
	RemoveBlip(gioielli3)
	RemoveBlip(gioielli4)
